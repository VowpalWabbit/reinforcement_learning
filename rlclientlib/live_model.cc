...
int live_model::request_continuous_action(
...
int live_model::request_decision(
...
int live_model::request_multi_slot_decision(
    const char* event_id, string_view context_json, unsigned int flags, multi_slot_response& resp, api_status* status)
{
  ...
  return _pimpl->request_multi_slot_decision(
      event_id, context_json, flags, resp, live_model::default_baseline_vector, status);
}
...
int live_model::request_multi_slot_decision(const char* event_id, string_view context_json, unsigned int flags,
...
int live_model::request_episodic_decision(const char* event_id, const char* previous_id, string_view context_json,
