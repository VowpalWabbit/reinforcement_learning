...
namespace reinforcement_learning
{
  namespace logger {
    ...
    public:
      ...
      virtual bool is_object_extraction_enabled() = 0;
      virtual bool is_serialization_transform_enabled() = 0;
      ...
      virtual int transform_serialized_payload(generic_event::payload_buffer_t& input, event_content_type &content_type, api_status* status) = 0;
