...
namespace reinforcement_learning { namespace model_management {
  ...
  {}
  restapi_data_transport::restapi_data_transport(i_http_client* httpcli, ::web::http::http_headers& header, bool api, i_trace* trace)
      : _httpcli(httpcli), _header(header), _api(api), _datasz{ 0 }, _trace{ trace }
  {}
