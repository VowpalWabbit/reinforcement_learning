...
public:
  ...
  restapi_data_transport_oauth(i_http_client* httpcli, i_trace* trace,
  ...
  restapi_data_transport_oauth(std::unique_ptr<i_http_client>&& httpcli, utility::configuration cfg,
      model_source model_source, i_trace* trace, std::unique_ptr<i_oauth_credentials_provider>&& cred_provider,
      std::string scope);
