...
namespace reinforcement_learning {
  ...
  int get_slot_ids_or_generate_from_index(const char* context, const ContextInfo::index_vector_t& slots, std::vector<std::string>& slot_ids, i_trace* trace = nullptr, api_status* status = nullptr);
}}
