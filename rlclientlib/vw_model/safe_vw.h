...
namespace reinforcement_learning {
  ...
  public:
    ...
    // Used for slates
    void rank_decisions(const char *event_id, uint32_t slot_count, const char* context, std::vector<std::vector<uint32_t>>& actions, std::vector<std::vector<float>>& scores);
