...
{
live_model_slates::live_model_slates(const utility::configuration& config, error_fn fn, void* err_context,
...
live_model_slates::live_model_slates(live_model_slates&& other) noexcept
{
  std::swap(_pimpl, other._pimpl);
  _initialized = other._initialized;
}

live_model_slates::~live_model_slates() = default;

live_model_slates& live_model_slates::operator=(live_model_slates&& other) noexcept
{
  std::swap(_pimpl, other._pimpl);
  _initialized = other._initialized;
  return *this;
...
int live_model_slates::init(api_status* status)
{
...
// not implemented yet
int live_model_slates::report_action_taken(const char* event_id, api_status* status)
{
  INIT_CHECK();
...
int live_model_slates::report_action_taken(const char* primary_id, const char* secondary_id, api_status* status)
{
  INIT_CHECK();
