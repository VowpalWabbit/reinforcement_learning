/**
 * @brief slot_ranking definition. slot_ranking contains the chosen action, along with the action probability
 * distribution for a slot.
 */
#pragma once
...
/**
 * @brief
 * slot_ranking contains all the actions and distribution from with the action was sampled.  It also contains the chosen
 * action id and the unique id representing the choice.
 */
class slot_ranking
{
public:
   ...
   *
   * @param id The unique identifier for this interaction.  This id must be used when reporting the outcome for this
   * action
   */
