...
namespace reinforcement_learning {
  ...
  public:
    ...
    /**
      ...
      */
    VW_DLL_PUBLIC slot_ranking(char const* id);
    ...
    * @param _id
    */
    VW_DLL_PUBLIC void set_id(const char* id);
    ...
    * @return int Error code
    */
    VW_DLL_PUBLIC int set_chosen_action_id_unchecked(size_t action_id, api_status* = nullptr);
    ...
    */
    VW_DLL_PUBLIC slot_ranking(slot_ranking&&) noexcept;
    ...
    */
    VW_DLL_PUBLIC slot_ranking& operator=(slot_ranking&&) noexcept;
