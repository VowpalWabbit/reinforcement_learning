 ...
 * continuous_action_response contains the chosen continuous action and the pdf value of the density function at the
 * chosen action's location. continuous_action_response also contains the unique event_id representing the choice. This
 * unique event_id must be used to report back outcomes against this choice for the online trainer.
 */
