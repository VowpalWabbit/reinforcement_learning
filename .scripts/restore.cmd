...
%vcpkgPath% install --host-triplet=x64-windows --triplet=x64-windows cpprestsdk openssl-windows zlib flatbuffers boost-filesystem boost-thread boost-program-options boost-test boost-align boost-math
