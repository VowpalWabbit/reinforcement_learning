...
cmake . -DCMAKE_TOOLCHAIN_FILE=%VcpkgCmake% -Wno-deprecated -DVCPKG_TARGET_TRIPLET=x64-windows-static-md -G "Visual Studio 15 2017" -A x64 -DCMAKE_CONFIGURATION_TYPES="Release" -DWARNING_AS_ERROR=OFF -DWARNINGS=OFF -DSTATIC_LINK_BINARY_PARSER=ON -DFMT_SYS_DEP=ON -DSPDLOG_SYS_DEP=ON
