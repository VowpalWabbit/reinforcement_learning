...
cmake -S external_parser -B build -DCMAKE_TOOLCHAIN_FILE=%VcpkgCmake% -Wno-deprecated -DVCPKG_TARGET_TRIPLET="x64-windows-static-md" -G "Visual Studio 15 2017" -A x64 -DWARNING_AS_ERROR=OFF -DWARNINGS=OFF
