...
cmake -S . -B build -A x64 -DCMAKE_TOOLCHAIN_FILE="%VcpkgCmake%" -DVCPKG_TARGET_TRIPLET=x64-windows-static-md-v141 -DVCPKG_HOST_TRIPLET=x64-windows-static-md-v141 -DVCPKG_MANIFEST_MODE=Off -DWARNING_AS_ERROR=OFF -Wno-deprecated
