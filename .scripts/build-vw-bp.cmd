...
cmake . -DCMAKE_TOOLCHAIN_FILE=%VcpkgCmake% -Wno-deprecated -DVCPKG_TARGET_TRIPLET=x64-windows-static-md-v141 -G "Visual Studio 16 2019" -A x64 -T v141 -DCMAKE_CONFIGURATION_TYPES="Release" -DWARNING_AS_ERROR=OFF -DWARNINGS=OFF --debug-find -DCMAKE_PROGRAM_PATH="%VCPKG_INSTALLATION_ROOT%\installed\x64-windows-static-md-v141\tools\flatbuffers\"
