...
po::variables_map process_cmd_line(const int argc, char** argv)
{
  ...
  desc.add_options()("help", "produce help message")("json_config,j",
      po::value<std::string>()->default_value("client.json"),
      "JSON file with config information for hosted RL loop")("message_size,s", po::value<size_t>()->default_value(100),
      "Message size in Kb")("message_count,n", po::value<size_t>()->default_value(1000000), "Amount of messages")(
