...
extern "C" {
    ...
    API reinforcement_learning::slot_response* PushSlotResponse(reinforcement_learning::decision_response*, const char*);
    ...
    API void SetDecisionModelId(reinforcement_learning::decision_response* decision, const char*);
