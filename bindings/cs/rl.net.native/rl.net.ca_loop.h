...
extern "C"
{
  ...
  API int CALoopRequestContinuousAction(ca_loop_context_t* ca_loop, const char* event_id,
  ...
  API int CALoopReportActionMultiIdTaken(ca_loop_context_t* ca_loop, const char* primary_id,
  ...
  API void CALoopSetCallback(
      ca_loop_context_t* ca_loop, rl_net_native::background_error_callback_t callback = nullptr);
