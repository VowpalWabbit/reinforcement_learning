    ...
    reinforcement_learning::utility::configuration* config, factory_context_t* factory_context)
{
  ...
  context->livemodel = new reinforcement_learning::live_model(*config, pipe_background_error_callback, context,
...
API int LiveModelChooseRank(livemodel_context_t* context, const char* event_id, const char* context_json,
...
API int LiveModelChooseRankWithFlags(livemodel_context_t* context, const char* event_id, const char* context_json,
...
API int LiveModelRequestContinuousAction(livemodel_context_t* context, const char* event_id, const char* context_json,
    int context_json_size, reinforcement_learning::continuous_action_response* resp,
    reinforcement_learning::api_status* status)
{
  RL_IGNORE_DEPRECATED_USAGE_START
  return context->livemodel->request_continuous_action(
      event_id, {context_json, static_cast<size_t>(context_json_size)}, *resp, status);
  RL_IGNORE_DEPRECATED_USAGE_END
}

API int LiveModelRequestContinuousActionWithFlags(livemodel_context_t* context, const char* event_id,
...
API int LiveModelRequestDecision(livemodel_context_t* context, const char* context_json, int context_json_size,
...
API int LiveModelRequestDecisionWithFlags(livemodel_context_t* context, const char* context_json, int context_json_size,
    unsigned int flags, reinforcement_learning::decision_response* resp, reinforcement_learning::api_status* status)
{
  RL_IGNORE_DEPRECATED_USAGE_START
  return context->livemodel->request_decision(
      {context_json, static_cast<size_t>(context_json_size)}, flags, *resp, status);
  RL_IGNORE_DEPRECATED_USAGE_END
}

API int LiveModelRequestMultiSlotDecision(livemodel_context_t* context, const char* event_id, const char* context_json,
    int context_json_size, reinforcement_learning::multi_slot_response* resp,
    reinforcement_learning::api_status* status)
{
  RL_IGNORE_DEPRECATED_USAGE_START
  if (event_id == nullptr)
    return context->livemodel->request_multi_slot_decision(
...
{
  RL_IGNORE_DEPRECATED_USAGE_START
  return context->livemodel->request_multi_slot_decision(event_id,
...
API int LiveModelReportOutcomeF(
    livemodel_context_t* context, const char* event_id, float outcome, reinforcement_learning::api_status* status)
{
  return context->livemodel->report_outcome(event_id, outcome, status);
}

API int LiveModelReportOutcomeJson(livemodel_context_t* context, const char* event_id, const char* outcome_json,
    reinforcement_learning::api_status* status)
{
...
API int LiveModelReportOutcomeSlotStringIdJson(livemodel_context_t* context, const char* event_id, const char* slot_id,
    const char* outcome_json, reinforcement_learning::api_status* status)
{
...
{
  livemodel->base_loop_context.background_error_callback = callback;
}

API void LiveModelSetTrace(livemodel_context_t* livemodel, rl_net_native::trace_logger_callback_t callback)
{
  livemodel->base_loop_context.trace_logger_callback = callback;
}