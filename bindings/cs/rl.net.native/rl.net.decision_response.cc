...
public:
  inline decision_enumerator_adapter(const reinforcement_learning::decision_response* response)
...
public:
  ...
  inline reinforcement_learning::slot_response const* operator*() const { return &*this->current; }
};

API const char* GetSlotSlotId(reinforcement_learning::slot_response* slot) { return slot->get_slot_id(); }

API int GetSlotActionId(reinforcement_learning::slot_response* slot) { return slot->get_action_id(); }

API float GetSlotProbability(reinforcement_learning::slot_response* slot) { return slot->get_probability(); }
...
API void DeleteDecisionResponse(reinforcement_learning::decision_response* decision) { delete decision; }

API size_t GetDecisionSize(reinforcement_learning::decision_response* decision) { return decision->size(); }
...
API void DeleteDecisionEnumeratorAdapter(decision_enumerator_adapter* adapter) { delete adapter; }

API int DecisionEnumeratorInit(decision_enumerator_adapter* adapter) { return adapter->check_current(); }

API int DecisionEnumeratorMoveNext(decision_enumerator_adapter* adapter) { return adapter->move_next(); }
