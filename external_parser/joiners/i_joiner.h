...
public:
  ...
  virtual void set_reward_function(
      const reinforcement_learning::messages::flatbuff::v2::RewardFunctionType type, bool sticky = false) = 0;
  virtual void set_default_reward(float default_reward, bool sticky = false) = 0;
  virtual void set_learning_mode_config(
      reinforcement_learning::messages::flatbuff::v2::LearningModeType learning_mode, bool sticky = false) = 0;
  virtual void set_problem_type_config(
      reinforcement_learning::messages::flatbuff::v2::ProblemType problem_type, bool sticky = false) = 0;
  ...
  virtual bool process_event(const reinforcement_learning::messages::flatbuff::v2::JoinedEvent& joined_event) = 0;
