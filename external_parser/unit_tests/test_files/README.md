...
- ccb_simple.log: generated by running `python joiner.py --problem_type_config 2` on the above files (ccb_v2.fb, f-reward_v2.fb) and renaming the resulting default `merged.log`
