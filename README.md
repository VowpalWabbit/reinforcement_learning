...
#### Dependencies
```cmd
vcpkg install --triplet x64-windows zlib boost-system boost-program-options boost-locale boost-test boost-align boost-foreach boost-math boost-uuid cpprestsdk flatbuffers
```
