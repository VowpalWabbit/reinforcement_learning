...
bool experiment_controller::is_running() const { return _is_running; }

size_t experiment_controller::get_iteration() const { return _iteration; }

void experiment_controller::stop() { _is_running = false; }
...
void iterations_experiment_controller::on_iterate() { _is_running = _iteration < _num_iterations; }

duration_experiment_controller::duration_experiment_controller(size_t duration) : _duration(duration) {}
