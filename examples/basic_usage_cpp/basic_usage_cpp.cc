...
int basic_usage_cb() {
  ...
  const std::string context = R"({"shared":{"sf":1},"_multi":[ { "TAction":{"af":1} },{"TAction":{"af":2}}]})";
  float outcome  = 1.0f;
...
int basic_usage_ca() {
  const std::string  event_id = "event_id";
  const std::string context = R"({"f1":1,"f2":1,"f3":1,"f4":1,"f5":1})";
  float outcome  = 1.0f;
...
int basic_usage_ccb() {
  const std::string context = R"({"shared":{"sf":1},"_multi":[ { "TAction":{"af":1} },{"TAction":{"af":2}},{"TAction":{"af":3}}],"_slots":[{"f":1}, {"f":2}]})";
...
int basic_usage_slates() {
  const std::string context = R"({"shared":{"sf":1},"_multi":[ {"_slot_id":0,"TAction":{"af":1} },{"_slot_id":0,"TAction":{"af":2}},{"_slot_id":1,"TAction":{"af":3}},{"_slot_id":1,"TAction":{"af":4}}],"_slots":[{"f":1}, {"f":2}]})";
